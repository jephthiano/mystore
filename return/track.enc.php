...
$page_url = file_location('home_url','return/track/'.$_GET['val']);
	...
	<div class='j-row j-home-padding'style='padding-top:0px;'>
		...
		<div class='j-col l8 xl9 j-padding-flexible'>
			<div class='j-color4 j-account-height'>
				...
				$user_id = content_data('return_table','u_id',$or_id,'or_id');
				if($order_id === false || $user_id !== $u_id){
					trigger_error_manual(404);
				}else{
					...
					<div class='j-padding'>
						<div class='j-padding'><?php track_return($order_id);?></div>
					</div>
					<?php
				}
				?>
