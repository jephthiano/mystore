...
$page = "CART | ".strtoupper(get_xml_data('company_name'));
$page_name = $page." | ".get_xml_data('seo_tag');
$page_url = file_location('home_url','cart/');;//url redirection current page
$keywords = get_json_data('keywords','about_us')."|".$page_name;
$description = $page_name;
insert_page_visit('cart');
?>
<!DOCTYPE html>
<html>
...
<body id="body"class="j-color6"style="font-family:Roboto,sans-serif;">
	...
	<div class='j-home-padding'>
		<div id='cartDiv'><?php get_cart();?></div>
	</div>
