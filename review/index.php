...
$page_url = file_location('home_url','review/');
require_once(file_location('inc_path','session_check.inc.php'));
//for meta
$follow_type = 'no follow';
$image_link = file_location('media_url','home/logo.png');
$image_type = substr($image_link,-3);
$page = "PENDING REVIEW | ".strtoupper(get_xml_data('company_name'));
$page_name = $page." | ".get_xml_data('seo_tag');
insert_page_visit('pending review');
?>
<!DOCTYPE html>
<html>
	...
	<div class='j-row j-home-padding'style='padding-top:0px;'>
		...
		<div class='j-col l8 xl9 j-padding-flexible'>
			<div class='j-color4 j-account-height'>
				<?php get_header('PENDING REVIEW','back',38)?>
				<?php require_once(file_location('inc_path','product_pagination.inc.php')); //pending review pagination?>				
				<br>
			</div>
		</div>
	</div>
