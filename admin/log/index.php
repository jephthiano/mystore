...
$page_url = file_location('admin_url','log/'.$_GET['page'].'/');
$page = "MANAGE LOGS";
...
<div class="j-row">
	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div id="maincol">
			<div class='j-padding'>
				<h2 class='j-text-color1 j-padding j-color4'><b>LOGS LIST</b></h2>
			</div>
			<center>
				<button type='submit'id=''class="j-right  j-btn j-medium j-color1 j-round j-bolder" onClick="$('#clear_log').fadeIn('slow');">Clear Logs</button>
				<div class="j-container">
					<input type="search"name="sx"id="sx"class="j-input j-border-2 j-border-color1 j-round"
					placeholder="Search all logs"style="width:96%;max-width:500px;outline:none;display:inline"onsearch="glr(<?=$page_num?>);"onkeyup="glr(<?=$page_num?>);"/>
				</div>
				<div id="shr"></div>
			</center>
			<span id="st"></span>
